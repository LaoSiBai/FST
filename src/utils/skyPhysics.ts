...
export const skyStops = [
    {
        name: '彻底黑夜',
        alpha: -18,
        zenith:  { l: 0.05, c: 0.01,  h: 260 },
        horizon: { l: 0.1,  c: 0.02,  h: 260 },
        haze:    { l: 0.08, c: 0.01,  h: 260 }
    },
    {
        name: '航海暮光',
        alpha: -9,
        // 查普伊斯臭氧吸收主导 → 极深邃的钴蓝色
        zenith:  { l: 0.2,  c: 0.08,  h: 275 },
        horizon: { l: 0.3,  c: 0.1,   h: 265 },
        haze:    { l: 0.35, c: 0.1,   h: 260 }
    },
    {
        name: '民用暮光',
        alpha: -2.5,
        // 太阳刚落下，天顶紫蓝，地平线暗红余晖
        zenith:  { l: 0.3,  c: 0.1,   h: 280 },
        horizon: { l: 0.45, c: 0.15,  h: 15 },
        haze:    { l: 0.5,  c: 0.15,  h: 30 }
    },
    {
        name: '物理日落',
        alpha: 0,
        // 光线与地平线相切，瑞利散射剥离蓝光，高饱和红橙色
        zenith:  { l: 0.4,  c: 0.15,  h: 270 },
        horizon: { l: 0.6,  c: 0.25,  h: 35 },
        haze:    { l: 0.75, c: 0.25,  h: 45 }
    },
    {
        name: '黄金时刻',
        alpha: 10,
        // 大气路径增长，蓝光散射殆尽，金黄暖色弥漫
        zenith:  { l: 0.65, c: 0.18,  h: 260 },
        horizon: { l: 0.8,  c: 0.12,  h: 70 },
        haze:    { l: 0.9,  c: 0.18,  h: 60 }
    },
    {
        name: '正午白昼',
        alpha: 45,
        // 瑞利散射主导，高饱和蓝色天顶，地平线米氏散射泛白
        zenith:  { l: 0.7,  c: 0.15,  h: 250 },
        horizon: { l: 0.85, c: 0.05,  h: 210 },
        haze:    { l: 0.9,  c: 0.02,  h: 90 }
    }
];
